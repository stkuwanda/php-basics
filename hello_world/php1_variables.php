<?php
  ...
  */
  ...
  echo "<br>";
  echo "var_dump(\$name'): "; var_dump($name); // var_dump to display detailed information about an array
  echo "<br>";
  echo "var_dump(\$person'): "; var_dump($person); // var_dump to display detailed information about a variable
  echo "<br>";
  echo "var_dump(\$age'): "; var_dump($age); // var_dump can also display integers
  echo "<br>";
  echo "var_dump(\$nothing'): "; var_dump($nothing); // var_dump can also display null
  echo "<br>";
  echo "var_dump(\$fruits'): "; var_dump($fruits); // var_export to display a parsable string representation of a variable
  echo "<br>";
  echo "var_export(\$fruits'): "; var_export($fruits); // var_export to display a parsable string representation of a variable
  echo "<br>";
